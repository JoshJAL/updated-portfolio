    ...
    <Layout>
      <Container>
        ...
        <SimpleGrid columns={[1, 1, 2]} gap={6}>
          <Section>
            <WorkGridItem id='periodicTables' title='Periodic Tables' thumbnail={thumbPeriodicTables}>
              A restaurant reservation system for a fictional restaurant
            </WorkGridItem>
          </Section>
          <Section>
            <WorkGridItem id='flashcard' title='Flashcard-O-Matic' thumbnail={thumbFlashCard}>
              A flashcard making app for taking notes and studying any subject
            </WorkGridItem>
          </Section>
          <Section>
            <WorkGridItem id='pomodoroTimer' title='Pomodoro Timer' thumbnail={thumbPomodoroTimer}>
              A study timer built around the Pomodoro Technique with a "Focus" timer and a "Break" timer
            </WorkGridItem>
          </Section>
          <Section>
            <WorkGridItem id='simpleCalculator' title='Simple Calculator' thumbnail={thumbSimpleCalc}>
              A simple calculator application that can add, subtract, multiply, and divide
            </WorkGridItem>
          </Section>
          <Section>
            <WorkGridItem id='ticketSolution' title='Ticketing Solution' thumbnail={thumbTicket}>
              A scalable ticking solution for any company or organization
            </WorkGridItem>
          </Section>
          <Section>
            <WorkGridItem id='javaSnake' title='Java Snake' thumbnail={thumbJavaSnake}>
              The classic game of Snake written in Java
            </WorkGridItem>
          </Section>
          <Section>
            <WorkGridItem id='javaCalc' title='Java Calculator' thumbnail={thumbJavaCalc}>
              A simple calculator application written in Java
            </WorkGridItem>
          </Section>
          <Section>
            <WorkGridItem id='adminDashboard' title='Admin Dashboard' thumbnail={thumbAdminDashboard}>
              An admin dashboard for an e-commerce; with light and dark mode
            </WorkGridItem>
          </Section>
          <Section>
            <WorkGridItem id='javaTextEditor' title='Text Editor' thumbnail={thumbTextEditor}>
