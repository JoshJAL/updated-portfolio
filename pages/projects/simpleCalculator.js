  ...
  return (
    <Layout title="Simple Calculator">
      <Container marginTop={4}>
        ...
        <P>
          A simple calculator application that can add, subtract, multiply and
          divide. Intended for simple mathematical problems.{' '}
        </P>
        <List ml={4} my={4}>
          <ListItem>
            <Meta>Working Application</Meta>
            <Link href="https://joshjal.github.io/simpleCalculator/">
              https://joshjal.github.io/simpleCalculator/{' '}
          ...
          <ListItem>
            ...
            <Link href="https://github.com/JoshJAL/simpleCalculator">
              https://github.com/JoshJAL/simpleCalculator{' '}
              <ExternalLinkIcon mx="2px" />
            </Link>
          </ListItem>
          <ListItem>
        ...
        <WorkImage
          src="/images/simpleCalc/simpleCalcHome.jpg"
          alt="Simple Calculator home page"
        />
        <WorkImage
        ...
        />
        <WorkImage
          src="/images/simpleCalc/simpleCalcAnswer.jpg"
          alt="Simple Calculator displaying answer"
        />
      </Container>
    </Layout>
  )
